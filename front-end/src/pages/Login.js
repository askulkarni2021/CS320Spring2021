...
import wlogo from '../kudos_logo_white.png'
  ...
  return (
    <Grid container direction="column" justify="center" alignItems="center" style={{ minHeight: '100vh'}}>
      <Grid item xs={12} sm={6} md={3} style={{padding: '10px', width: '80%'}}>
          {localStorage.getItem('darkState') === "false"? <img className="img-responsive" src={logo} alt="logo"/>: <img className="img-responsive" src={wlogo} alt="wlogo"/>}
